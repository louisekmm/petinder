<div id="page-wrapper">
	<div class='row'>
		<div class="col-sm-12">
			...
			<form method='post' action='entidade_pessoa/doimport/<?=$this->id?>/' enctype="multipart/form-data">
			<ol class="breadcrumb">
			...
			<a href="<?=URL?>/class/modelo_entidadepessoa.csv"><?=$this->lng['modelo_import']?> CSV</a><br><Br>

...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/   
    ...
    #       
  {
    ...
    //imageantialias($this->imageResized, true);
	//imageantialias($cornerImg, true);
    imagefilledellipse($cornerImg, $radius/2, $radius/2, $radius , $radius , $maskColor );
	//imagecopyresampled($cornerImg,$cornerImg,0,0,0,0, $radius,$radius,$radius*2,$radius*2);
	//include ("./imageSmoothArc.php");
	
    //imageSmoothArc($cornerImg, $radius/2, $radius/2, $radius, $radius, $maskColor, 0 , 2*pi());

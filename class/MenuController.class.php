...
/*		if (LoginController::getTipo($di) == 2) {
	...
	public static function _exportar($a='', $slug_formulario = '') {
		...
		switch(LoginController::getTipo($di)) {
			...
			case 1: //admin
				$inner .= ' LEFT JOIN admin aC ON aC.id=a.idAdmin LEFT JOIN admin_tipo adm ON adm.id=aC.idAdmin_Tipo AND adm.idAcl=4'; //achou o coordenador
				$inner .= ' LEFT JOIN admin aR ON aR.id=aC.idAdminLEFT JOIN admin_tipo adm ON adm.id=aR.idAdmin_Tipo AND adm.idAcl=3'; //achou o gerente regional
			...
			case 2: //cliente
				$inner .= ' LEFT JOIN admin aC ON aC.id=a.idAdmin LEFT JOIN admin_tipo adm ON adm.id=aC.idAdmin_Tipo AND adm.idAcl=4'; //achou o coordenador
				$inner .= ' LEFT JOIN admin aR ON aR.id=aC.idAdmin LEFT JOIN admin_tipo adm ON adm.id=aR.idAdmin_Tipo AND adm.idAcl=3'; //achou o gerente regional
